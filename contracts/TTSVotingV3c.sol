...
//
// Deployment sequence (same as V3b — replace V3b_ADDRESS with V3c_ADDRESS):
//   1.  Deploy this contract -> note V3c_ADDRESS
//   2.  V3c.transferOwnership("0xB17b3842E2CFf594d8886e77277f4B6fC7C61A48")
//   3.  keeper.setVotingContract("V3c_ADDRESS")
//   4.  keeper.acceptVotingOwnership("V3c_ADDRESS")
//   5.  V3c.setNFTContract("0x0768e862D3AB14d85213BfeF8f1D012E77721da2")
//   6.  V3c.batchApproveProfiles(profileIds[], wallets[])
//   7.  Add V3c_ADDRESS as VRF consumer at vrf.chain.link/base
